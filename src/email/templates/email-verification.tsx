...
export const EmailVerificationTemplate = ({ code }: EmailVerificationTemplateProps) => {
  return (
    <Html>
      <Head />
      <Preview>Verify your email address to complete your ACME registration</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Text style={title}>ACME</Text>
            <Text style={text}>Hi,</Text>
            <Text style={text}>
              Thank you for registering for an account on ACME. To complete your
