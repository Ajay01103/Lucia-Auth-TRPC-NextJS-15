        ...
        <div className="mx-auto px-6 max-w-6xl text-gray-500">
          <div className="text-center">
            <h2 className="text-3xl text-gray-950 dark:text-white font-semibold">
              Features of the Auth Template
            </h2>
            <p className="mt-6 text-gray-700 max-w-xl mx-auto dark:text-gray-300">
              These are the tools and technologies used in this template. Feel free to add
              or remove other features and functionality that suits your needs
            </p>
          </div>
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-3.5">
              ...
              <div className="relative">
                <div className="border border-blue-500/10 flex relative *:relative *:size-8 *:m-auto size-12 rounded-lg dark:bg-gray-900 dark:border-white/15 before:rounded-[7px] before:absolute before:inset-0 before:border-t before:border-white before:from-blue-100 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-950">
                  <svg
                    ...
                    className="h-12 w-12"
                  >
                    <path d="m1647.66,1673.36L1000,72.73,352.34,1673.36l-102.74,253.91h1500.8l-102.74-253.91Zm-647.66-549l-442.82,545.39,99.55-246.04,343.27-848.35,343.26,848.35,99.55,246.04-442.81-545.39Z"></path>
                  </svg>
                </div>
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    React Email + Nodemailer for customized emails
                  </p>
                </div>
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Shad CN for unique and visually appealing design system
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                  <a
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Next JS app router with incredible server components and server
                    actions
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    Drizzle ORM for handling Schema of database smoothly
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                  <a
            ...
            <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
              ...
              <div className="relative">
                ...
                <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                  <p className="text-gray-700 dark:text-gray-300">
                    TRPC backend for bullet proof typesafety
                  </p>
                </div>
                <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                  <a
